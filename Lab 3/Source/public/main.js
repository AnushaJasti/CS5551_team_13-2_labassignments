...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getContacts();
        this.socket.on('newContactAdded', function () {
            _this.getContacts();
        });
    };
    AppComponent.prototype.addContact = function (contact) {
    ...
    AppComponent.prototype.update = function (contact) {
        this.isUpdate = false;
    };
    //Updated the Contact
    AppComponent.prototype.updateContact = function (contact) {
        var url = 'http://localhost:3000/contact/update/' + contact["_id"];
    ...
    AppComponent.prototype.deleteContact = function (contact) {
        var url = 'http://localhost:3000/contact/delete/' + contact["_id"];
...
module.exports = __webpack_require__(/*! D:\Learning\Contact\client\src\main.ts */"./src/main.ts");
